...
//        editTaskB.setEnabled(true);
        ...
        startTimerB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ppStartTimer_actionPerformed(e);
            }
        });
        startTimerB.setPreferredSize(new Dimension(24, 24));
        startTimerB.setRequestFocusEnabled(false);
        ...
        stopTimerB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ppStopTimer_actionPerformed(e);
            }
        });
        stopTimerB.setPreferredSize(new Dimension(24, 24));
        stopTimerB.setRequestFocusEnabled(false);
...
//			new ImageIcon(net.sf.memoranda.ui.AppFrame.class.getResource("resources/icons/todo_remove.png")));
        ...
        ppEditTask.setIcon(new ImageIcon(net.sf.memoranda.ui.AppFrame.class
                    .getResource("resources/icons/todo_edit.png")));
        ...
        ppRemoveTask.setIcon(new ImageIcon(net.sf.memoranda.ui.AppFrame.class
                    .getResource("resources/icons/todo_remove.png")));
        ...
        ppNewTask.setIcon(new ImageIcon(net.sf.memoranda.ui.AppFrame.class
        ...
        ppAddSubTask.setIcon(new ImageIcon(net.sf.memoranda.ui.AppFrame.class
                    .getResource("resources/icons/todo_new_sub.png")));
    ...
    */
        ...
        ppCompleteTask.setIcon(new ImageIcon(net.sf.memoranda.ui.AppFrame.class
...
//		CurrentProject.getTaskList().adjustParentTasks(newTask);
    ...
    void addSubTask_actionPerformed(ActionEvent e) {
        TaskDialog dlg =
            new TaskDialog(App.getFrame(), Local.getString("New Task"));
        String parentTaskId =
...
//      //taskTable.updateUI();
  ...
  void ppStartTimer_actionPerformed(ActionEvent e) {
      startTimer_actionPerformed(e);
  }
